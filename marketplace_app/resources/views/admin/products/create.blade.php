    ...
    <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-6">
            ...
            <textarea name="description" id="description" rows="4" 
                      class="w-full bg-[#09090b] border border-zinc-800 rounded-md px-3.5 py-2.5 text-sm text-white focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-colors placeholder-zinc-600">{{ old('description') }}</textarea>
        ...
        <div class="mb-6">
            <label for="image" class="block text-sm font-medium text-zinc-300 mb-2">Product Image</label>
